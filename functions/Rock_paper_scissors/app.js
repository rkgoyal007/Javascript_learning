...
const getWinner = (cChoice,pChoice = DEFAULT_USER_CHOICE) =>{               //Default argument
...
//   alert('The result after adding all the number is'+ result);
// };

// sumUp(showResult,2,3,4,5,5); 
...
// combine(showResult.bind(this, 'The result after adding all numbers is:'),'ADD',1, 5,-3,6,10);
